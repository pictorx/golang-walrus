...
// 	protoc        v7.35.1
// source: suigrpc/signature_verification_service.proto
...
func (x *VerifySignatureRequest) Reset() {
	*x = VerifySignatureRequest{}
	mi := &file_suigrpc_signature_verification_service_proto_msgTypes[0]
...
func (*VerifySignatureRequest) Descriptor() ([]byte, []int) {
	return file_suigrpc_signature_verification_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *VerifySignatureResponse) Reset() {
	*x = VerifySignatureResponse{}
	mi := &file_suigrpc_signature_verification_service_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*VerifySignatureResponse) Descriptor() ([]byte, []int) {
	return file_suigrpc_signature_verification_service_proto_rawDescGZIP(), []int{1}
}
...
var File_suigrpc_signature_verification_service_proto protoreflect.FileDescriptor

const file_suigrpc_signature_verification_service_proto_rawDesc = "" +
	"\n" +
	",suigrpc/signature_verification_service.proto\x12\n" +
	"sui.rpc.v2\x1a\x11suigrpc/bcs.proto\x1a\x17suigrpc/signature.proto\x1a\x19suigrpc/transaction.proto\"\xf6\x01\n" +
...
var (
	file_suigrpc_signature_verification_service_proto_rawDescOnce sync.Once
	file_suigrpc_signature_verification_service_proto_rawDescData []byte
)

func file_suigrpc_signature_verification_service_proto_rawDescGZIP() []byte {
	file_suigrpc_signature_verification_service_proto_rawDescOnce.Do(func() {
		file_suigrpc_signature_verification_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_suigrpc_signature_verification_service_proto_rawDesc), len(file_suigrpc_signature_verification_service_proto_rawDesc)))
	})
	return file_suigrpc_signature_verification_service_proto_rawDescData
}

var file_suigrpc_signature_verification_service_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_suigrpc_signature_verification_service_proto_goTypes = []any{
...
var file_suigrpc_signature_verification_service_proto_depIdxs = []int32{
...
func init() { file_suigrpc_signature_verification_service_proto_init() }
func file_suigrpc_signature_verification_service_proto_init() {
	if File_suigrpc_signature_verification_service_proto != nil {
		return
	}
	file_suigrpc_bcs_proto_init()
	file_suigrpc_signature_proto_init()
	file_suigrpc_transaction_proto_init()
	file_suigrpc_signature_verification_service_proto_msgTypes[0].OneofWrappers = []any{}
	file_suigrpc_signature_verification_service_proto_msgTypes[1].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_suigrpc_signature_verification_service_proto_rawDesc), len(file_suigrpc_signature_verification_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_suigrpc_signature_verification_service_proto_goTypes,
		DependencyIndexes: file_suigrpc_signature_verification_service_proto_depIdxs,
		MessageInfos:      file_suigrpc_signature_verification_service_proto_msgTypes,
	}.Build()
	File_suigrpc_signature_verification_service_proto = out.File
	file_suigrpc_signature_verification_service_proto_goTypes = nil
	file_suigrpc_signature_verification_service_proto_depIdxs = nil
}
