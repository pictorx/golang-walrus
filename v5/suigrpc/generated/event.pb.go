...
func (x *TransactionEvents) Reset() {
	*x = TransactionEvents{}
	mi := &file_suigrpc_event_proto_msgTypes[0]
...
func (*TransactionEvents) Descriptor() ([]byte, []int) {
	return file_suigrpc_event_proto_rawDescGZIP(), []int{0}
}
...
func (x *Event) Reset() {
	*x = Event{}
	mi := &file_suigrpc_event_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Event) Descriptor() ([]byte, []int) {
	return file_suigrpc_event_proto_rawDescGZIP(), []int{1}
}
...
var File_suigrpc_event_proto protoreflect.FileDescriptor

const file_suigrpc_event_proto_rawDesc = "" +
	"\n" +
	"\x13suigrpc/event.proto\x12\n" +
	"sui.rpc.v2\x1a\x1cgoogle/protobuf/struct.proto\x1a\x11suigrpc/bcs.proto\"\x96\x01\n" +
...
var (
	file_suigrpc_event_proto_rawDescOnce sync.Once
	file_suigrpc_event_proto_rawDescData []byte
)

func file_suigrpc_event_proto_rawDescGZIP() []byte {
	file_suigrpc_event_proto_rawDescOnce.Do(func() {
		file_suigrpc_event_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_suigrpc_event_proto_rawDesc), len(file_suigrpc_event_proto_rawDesc)))
	})
	return file_suigrpc_event_proto_rawDescData
}

var file_suigrpc_event_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_suigrpc_event_proto_goTypes = []any{
...
var file_suigrpc_event_proto_depIdxs = []int32{
...
func init() { file_suigrpc_event_proto_init() }
func file_suigrpc_event_proto_init() {
	if File_suigrpc_event_proto != nil {
		return
	}
	file_suigrpc_bcs_proto_init()
	file_suigrpc_event_proto_msgTypes[0].OneofWrappers = []any{}
	file_suigrpc_event_proto_msgTypes[1].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_suigrpc_event_proto_rawDesc), len(file_suigrpc_event_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_suigrpc_event_proto_goTypes,
		DependencyIndexes: file_suigrpc_event_proto_depIdxs,
		MessageInfos:      file_suigrpc_event_proto_msgTypes,
	}.Build()
	File_suigrpc_event_proto = out.File
	file_suigrpc_event_proto_goTypes = nil
	file_suigrpc_event_proto_depIdxs = nil
}
