...
func (x *Object) Reset() {
	*x = Object{}
	mi := &file_suigrpc_object_proto_msgTypes[0]
...
func (*Object) Descriptor() ([]byte, []int) {
	return file_suigrpc_object_proto_rawDescGZIP(), []int{0}
}
...
func (x *ObjectSet) Reset() {
	*x = ObjectSet{}
	mi := &file_suigrpc_object_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ObjectSet) Descriptor() ([]byte, []int) {
	return file_suigrpc_object_proto_rawDescGZIP(), []int{1}
}
...
var File_suigrpc_object_proto protoreflect.FileDescriptor

const file_suigrpc_object_proto_rawDesc = "" +
	"\n" +
	"\x14suigrpc/object.proto\x12\n" +
	"sui.rpc.v2\x1a\x1cgoogle/protobuf/struct.proto\x1a\x11suigrpc/bcs.proto\x1a\x1asuigrpc/move_package.proto\x1a\x13suigrpc/owner.proto\"\xea\x05\n" +
	"\x06Object\x12&\n" +
...
var (
	file_suigrpc_object_proto_rawDescOnce sync.Once
	file_suigrpc_object_proto_rawDescData []byte
)

func file_suigrpc_object_proto_rawDescGZIP() []byte {
	file_suigrpc_object_proto_rawDescOnce.Do(func() {
		file_suigrpc_object_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_suigrpc_object_proto_rawDesc), len(file_suigrpc_object_proto_rawDesc)))
	})
	return file_suigrpc_object_proto_rawDescData
}

var file_suigrpc_object_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_suigrpc_object_proto_goTypes = []any{
...
var file_suigrpc_object_proto_depIdxs = []int32{
...
func init() { file_suigrpc_object_proto_init() }
func file_suigrpc_object_proto_init() {
	if File_suigrpc_object_proto != nil {
		return
	}
	file_suigrpc_bcs_proto_init()
	file_suigrpc_move_package_proto_init()
	file_suigrpc_owner_proto_init()
	file_suigrpc_object_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_suigrpc_object_proto_rawDesc), len(file_suigrpc_object_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_suigrpc_object_proto_goTypes,
		DependencyIndexes: file_suigrpc_object_proto_depIdxs,
		MessageInfos:      file_suigrpc_object_proto_msgTypes,
	}.Build()
	File_suigrpc_object_proto = out.File
	file_suigrpc_object_proto_goTypes = nil
	file_suigrpc_object_proto_depIdxs = nil
}
