...
// 	protoc        v6.33.1
// source: sui_rpc_proto/signature_verification_service.proto
...
func (x *VerifySignatureRequest) Reset() {
	*x = VerifySignatureRequest{}
	mi := &file_sui_rpc_proto_signature_verification_service_proto_msgTypes[0]
...
func (*VerifySignatureRequest) Descriptor() ([]byte, []int) {
	return file_sui_rpc_proto_signature_verification_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *VerifySignatureResponse) Reset() {
	*x = VerifySignatureResponse{}
	mi := &file_sui_rpc_proto_signature_verification_service_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*VerifySignatureResponse) Descriptor() ([]byte, []int) {
	return file_sui_rpc_proto_signature_verification_service_proto_rawDescGZIP(), []int{1}
}
...
var File_sui_rpc_proto_signature_verification_service_proto protoreflect.FileDescriptor

const file_sui_rpc_proto_signature_verification_service_proto_rawDesc = "" +
	"\n" +
	"2sui_rpc_proto/signature_verification_service.proto\x12\n" +
	"sui.rpc.v2\x1a\x17sui_rpc_proto/bcs.proto\x1a\x1dsui_rpc_proto/signature.proto\x1a\x1fsui_rpc_proto/transaction.proto\"\xf6\x01\n" +
	...
	"\x0fVerifySignature\x12\".sui.rpc.v2.VerifySignatureRequest\x1a#.sui.rpc.v2.VerifySignatureResponseB\rZ\v./generatedb\x06proto3"

var (
	file_sui_rpc_proto_signature_verification_service_proto_rawDescOnce sync.Once
	file_sui_rpc_proto_signature_verification_service_proto_rawDescData []byte
)

func file_sui_rpc_proto_signature_verification_service_proto_rawDescGZIP() []byte {
	file_sui_rpc_proto_signature_verification_service_proto_rawDescOnce.Do(func() {
		file_sui_rpc_proto_signature_verification_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_sui_rpc_proto_signature_verification_service_proto_rawDesc), len(file_sui_rpc_proto_signature_verification_service_proto_rawDesc)))
	})
	return file_sui_rpc_proto_signature_verification_service_proto_rawDescData
}

var file_sui_rpc_proto_signature_verification_service_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_sui_rpc_proto_signature_verification_service_proto_goTypes = []any{
...
var file_sui_rpc_proto_signature_verification_service_proto_depIdxs = []int32{
...
func init() { file_sui_rpc_proto_signature_verification_service_proto_init() }
func file_sui_rpc_proto_signature_verification_service_proto_init() {
	if File_sui_rpc_proto_signature_verification_service_proto != nil {
		return
	}
	file_sui_rpc_proto_bcs_proto_init()
	file_sui_rpc_proto_signature_proto_init()
	file_sui_rpc_proto_transaction_proto_init()
	file_sui_rpc_proto_signature_verification_service_proto_msgTypes[0].OneofWrappers = []any{}
	file_sui_rpc_proto_signature_verification_service_proto_msgTypes[1].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_sui_rpc_proto_signature_verification_service_proto_rawDesc), len(file_sui_rpc_proto_signature_verification_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_sui_rpc_proto_signature_verification_service_proto_goTypes,
		DependencyIndexes: file_sui_rpc_proto_signature_verification_service_proto_depIdxs,
		MessageInfos:      file_sui_rpc_proto_signature_verification_service_proto_msgTypes,
	}.Build()
	File_sui_rpc_proto_signature_verification_service_proto = out.File
	file_sui_rpc_proto_signature_verification_service_proto_goTypes = nil
	file_sui_rpc_proto_signature_verification_service_proto_depIdxs = nil
}
