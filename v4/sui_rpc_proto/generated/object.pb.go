...
// 	protoc        v6.33.1
// source: sui_rpc_proto/object.proto
...
func (x *Object) Reset() {
	*x = Object{}
	mi := &file_sui_rpc_proto_object_proto_msgTypes[0]
...
func (*Object) Descriptor() ([]byte, []int) {
	return file_sui_rpc_proto_object_proto_rawDescGZIP(), []int{0}
}
...
func (x *ObjectSet) Reset() {
	*x = ObjectSet{}
	mi := &file_sui_rpc_proto_object_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ObjectSet) Descriptor() ([]byte, []int) {
	return file_sui_rpc_proto_object_proto_rawDescGZIP(), []int{1}
}
...
var File_sui_rpc_proto_object_proto protoreflect.FileDescriptor

const file_sui_rpc_proto_object_proto_rawDesc = "" +
	"\n" +
	"\x1asui_rpc_proto/object.proto\x12\n" +
	"sui.rpc.v2\x1a\x1cgoogle/protobuf/struct.proto\x1a\x17sui_rpc_proto/bcs.proto\x1a sui_rpc_proto/move_package.proto\x1a\x19sui_rpc_proto/owner.proto\"\xea\x05\n" +
	"\x06Object\x12&\n" +
	...
	"\b_balance\"9\n" +
	"\tObjectSet\x12,\n" +
	"\aobjects\x18\x01 \x03(\v2\x12.sui.rpc.v2.ObjectR\aobjectsB\rZ\v./generatedb\x06proto3"

var (
	file_sui_rpc_proto_object_proto_rawDescOnce sync.Once
	file_sui_rpc_proto_object_proto_rawDescData []byte
)

func file_sui_rpc_proto_object_proto_rawDescGZIP() []byte {
	file_sui_rpc_proto_object_proto_rawDescOnce.Do(func() {
		file_sui_rpc_proto_object_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_sui_rpc_proto_object_proto_rawDesc), len(file_sui_rpc_proto_object_proto_rawDesc)))
	})
	return file_sui_rpc_proto_object_proto_rawDescData
}

var file_sui_rpc_proto_object_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_sui_rpc_proto_object_proto_goTypes = []any{
...
var file_sui_rpc_proto_object_proto_depIdxs = []int32{
...
func init() { file_sui_rpc_proto_object_proto_init() }
func file_sui_rpc_proto_object_proto_init() {
	if File_sui_rpc_proto_object_proto != nil {
		return
	}
	file_sui_rpc_proto_bcs_proto_init()
	file_sui_rpc_proto_move_package_proto_init()
	file_sui_rpc_proto_owner_proto_init()
	file_sui_rpc_proto_object_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_sui_rpc_proto_object_proto_rawDesc), len(file_sui_rpc_proto_object_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_sui_rpc_proto_object_proto_goTypes,
		DependencyIndexes: file_sui_rpc_proto_object_proto_depIdxs,
		MessageInfos:      file_sui_rpc_proto_object_proto_msgTypes,
	}.Build()
	File_sui_rpc_proto_object_proto = out.File
	file_sui_rpc_proto_object_proto_goTypes = nil
	file_sui_rpc_proto_object_proto_depIdxs = nil
}
