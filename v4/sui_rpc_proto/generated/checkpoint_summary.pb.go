...
// 	protoc        v6.33.1
// source: sui_rpc_proto/checkpoint_summary.proto
...
func (CheckpointCommitment_CheckpointCommitmentKind) Descriptor() protoreflect.EnumDescriptor {
	return file_sui_rpc_proto_checkpoint_summary_proto_enumTypes[0].Descriptor()
}

func (CheckpointCommitment_CheckpointCommitmentKind) Type() protoreflect.EnumType {
	return &file_sui_rpc_proto_checkpoint_summary_proto_enumTypes[0]
}
...
func (CheckpointCommitment_CheckpointCommitmentKind) EnumDescriptor() ([]byte, []int) {
	return file_sui_rpc_proto_checkpoint_summary_proto_rawDescGZIP(), []int{2, 0}
}
...
func (x *CheckpointSummary) Reset() {
	*x = CheckpointSummary{}
	mi := &file_sui_rpc_proto_checkpoint_summary_proto_msgTypes[0]
...
func (*CheckpointSummary) Descriptor() ([]byte, []int) {
	return file_sui_rpc_proto_checkpoint_summary_proto_rawDescGZIP(), []int{0}
}
...
func (x *EndOfEpochData) Reset() {
	*x = EndOfEpochData{}
	mi := &file_sui_rpc_proto_checkpoint_summary_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*EndOfEpochData) Descriptor() ([]byte, []int) {
	return file_sui_rpc_proto_checkpoint_summary_proto_rawDescGZIP(), []int{1}
}
...
func (x *CheckpointCommitment) Reset() {
	*x = CheckpointCommitment{}
	mi := &file_sui_rpc_proto_checkpoint_summary_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CheckpointCommitment) Descriptor() ([]byte, []int) {
	return file_sui_rpc_proto_checkpoint_summary_proto_rawDescGZIP(), []int{2}
}
...
var File_sui_rpc_proto_checkpoint_summary_proto protoreflect.FileDescriptor

const file_sui_rpc_proto_checkpoint_summary_proto_rawDesc = "" +
	"\n" +
	"&sui_rpc_proto/checkpoint_summary.proto\x12\n" +
	"sui.rpc.v2\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x17sui_rpc_proto/bcs.proto\x1a$sui_rpc_proto/gas_cost_summary.proto\x1a\x1dsui_rpc_proto/signature.proto\"\x83\a\n" +
	...
	"\x05_kindB\t\n" +
	"\a_digestB\rZ\v./generatedb\x06proto3"

var (
	file_sui_rpc_proto_checkpoint_summary_proto_rawDescOnce sync.Once
	file_sui_rpc_proto_checkpoint_summary_proto_rawDescData []byte
)

func file_sui_rpc_proto_checkpoint_summary_proto_rawDescGZIP() []byte {
	file_sui_rpc_proto_checkpoint_summary_proto_rawDescOnce.Do(func() {
		file_sui_rpc_proto_checkpoint_summary_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_sui_rpc_proto_checkpoint_summary_proto_rawDesc), len(file_sui_rpc_proto_checkpoint_summary_proto_rawDesc)))
	})
	return file_sui_rpc_proto_checkpoint_summary_proto_rawDescData
}

var file_sui_rpc_proto_checkpoint_summary_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_sui_rpc_proto_checkpoint_summary_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_sui_rpc_proto_checkpoint_summary_proto_goTypes = []any{
...
var file_sui_rpc_proto_checkpoint_summary_proto_depIdxs = []int32{
...
func init() { file_sui_rpc_proto_checkpoint_summary_proto_init() }
func file_sui_rpc_proto_checkpoint_summary_proto_init() {
	if File_sui_rpc_proto_checkpoint_summary_proto != nil {
		return
	}
	file_sui_rpc_proto_bcs_proto_init()
	file_sui_rpc_proto_gas_cost_summary_proto_init()
	file_sui_rpc_proto_signature_proto_init()
	file_sui_rpc_proto_checkpoint_summary_proto_msgTypes[0].OneofWrappers = []any{}
	file_sui_rpc_proto_checkpoint_summary_proto_msgTypes[1].OneofWrappers = []any{}
	file_sui_rpc_proto_checkpoint_summary_proto_msgTypes[2].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_sui_rpc_proto_checkpoint_summary_proto_rawDesc), len(file_sui_rpc_proto_checkpoint_summary_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_sui_rpc_proto_checkpoint_summary_proto_goTypes,
		DependencyIndexes: file_sui_rpc_proto_checkpoint_summary_proto_depIdxs,
		EnumInfos:         file_sui_rpc_proto_checkpoint_summary_proto_enumTypes,
		MessageInfos:      file_sui_rpc_proto_checkpoint_summary_proto_msgTypes,
	}.Build()
	File_sui_rpc_proto_checkpoint_summary_proto = out.File
	file_sui_rpc_proto_checkpoint_summary_proto_goTypes = nil
	file_sui_rpc_proto_checkpoint_summary_proto_depIdxs = nil
}
